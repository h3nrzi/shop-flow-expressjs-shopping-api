...
router
	.route("/")
	.get(
		notificationController.getCurrentUserNotifications.bind(
...
router
	.route("/unread-count")
	.get(notificationController.getUnreadCount.bind(notificationController));

router
	.route("/mark-all-read")
	.patch(notificationController.markAllAsRead.bind(notificationController));
