...
describe("GET /api/users/:id", () => {
    describe("should return 401", () => {
        it("If no token is provided", () => __awaiter(void 0, void 0, void 0, function* () {
            const res = yield (0, admin_helper_1.getUserRequest)("", userId);
        ...
        it("If token is invalid", () => __awaiter(void 0, void 0, void 0, function* () {
            const res = yield (0, admin_helper_1.getUserRequest)("jwt=invalid-token", userId);
            expect(res.status).toBe(401);
            expect(res.body.errors[0].field).toBeNull();
        ...
        it("If user for token does not exist", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const res = yield (0, admin_helper_1.getUserRequest)(`jwt=${fakeToken}`, userId);
            expect(res.status).toBe(401);
            expect(res.body.errors[0].field).toBeNull();
        ...
        it("If user is inactive", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const res = yield (0, admin_helper_1.getUserRequest)(cookie, userId);
            expect(res.status).toBe(401);
            expect(res.body.errors[0].field).toBeNull();
        ...
        it("If user's role is not admin", () => __awaiter(void 0, void 0, void 0, function* () {
            const res = yield (0, admin_helper_1.getUserRequest)(userCookie, userId);
            expect(res.status).toBe(401);
    ...
    describe("should return 400", () => {
        validationCases.forEach(({ description, params, expectedMessage }) => {
            it(description, () => __awaiter(void 0, void 0, void 0, function* () {
                const res = yield (0, admin_helper_1.getUserRequest)(adminCookie, params.id);
    ...
    describe("should return 404", () => {
        it("If the user does not exist", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const res = yield (0, admin_helper_1.getUserRequest)(adminCookie, nonExistentId.toString());
    ...
    describe("should return 200", () => {
        it("For admin", () => __awaiter(void 0, void 0, void 0, function* () {
            const res = yield (0, admin_helper_1.getUserRequest)(adminCookie, userId);
            expect(res.status).toBe(200);
            expect(res.body.data.user).toBeDefined();
        }));
        it("For main admin", () => __awaiter(void 0, void 0, void 0, function* () {
            const res = yield (0, admin_helper_1.getUserRequest)(mainAdminCookie, userId);
            expect(res.status).toBe(200);
            expect(res.body.data.user).toBeDefined();
        }));
    });
