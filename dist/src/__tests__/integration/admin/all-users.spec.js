...
describe("GET /api/users", () => {
    describe("should return 401", () => {
        it("If no token is provided", () => __awaiter(void 0, void 0, void 0, function* () {
            const res = yield (0, admin_helper_1.allUsersRequest)("");
        ...
        it("If token is invalid", () => __awaiter(void 0, void 0, void 0, function* () {
            const res = yield (0, admin_helper_1.allUsersRequest)("jwt=invalid-token");
            expect(res.status).toBe(401);
            expect(res.body.errors[0].field).toBeNull();
        ...
        it("If user for token does not exist", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const res = yield (0, admin_helper_1.allUsersRequest)(`jwt=${fakeToken}`);
            expect(res.status).toBe(401);
            expect(res.body.errors[0].field).toBeNull();
        ...
        it("If user is inactive", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const res = yield (0, admin_helper_1.allUsersRequest)(cookie);
            expect(res.status).toBe(401);
            expect(res.body.errors[0].field).toBeNull();
    ...
    describe("should return 200", () => {
        it("If user is admin", () => __awaiter(void 0, void 0, void 0, function* () {
            for (let i = 0; i < 2; i++) {
                yield (0, admin_helper_1.createProductRequest)(adminCookie, products_helper_1.validProduct);
            }
            const res = yield (0, admin_helper_1.allUsersRequest)(adminCookie);
