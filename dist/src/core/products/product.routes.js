...
router.patch("/:id", (0, express_validator_1.param)("id").isMongoId().withMessage("شناسه محصول معتبر نیست"), (0, express_validator_1.body)("name").optional().isString().withMessage("نام محصول الزامی است"), (0, express_validator_1.body)("description")
    .optional()
    .isString()
    .withMessage("توضیحات محصول الزامی است"), (0, express_validator_1.body)("image").optional().isString().withMessage("تصویر محصول الزامی است"), (0, express_validator_1.body)("countInStock")
    .optional()
    .isInt({ min: 0 })
    .withMessage("تعداد محصولات الزامی است"), (0, express_validator_1.body)("isAvailable")
    .optional()
    .isBoolean()
    .withMessage("وضعیت محصول الزامی است"), (0, express_validator_1.body)("brand").optional().isString().withMessage("برند محصول الزامی است"), (0, express_validator_1.body)("category")
    .optional()
    .isString()
    .withMessage("دسته بندی محصول الزامی است"), (0, express_validator_1.body)("rating").optional().isNumeric().withMessage("امتیاز محصول الزامی است"), (0, express_validator_1.body)("numReviews")
    .optional()
    .isInt({ min: 0 })
    .withMessage("تعداد بازخوردها محصول الزامی است"), (0, express_validator_1.body)("price").optional().isNumeric().withMessage("قیمت محصول الزامی است"), (0, express_validator_1.body)("discount").optional().isNumeric().withMessage("تخفیف محصول الزامی است"), validate_request_1.validateRequest, __1.productController.updateProduct.bind(__1.productController));
